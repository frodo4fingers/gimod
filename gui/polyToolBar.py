...
class PolyToolBar(QToolBar):
    """
        Provides the toolbar with all actions to load, build, correct (etc.) a
        polygon and manages the behaviour of itself
    """
    ...
    def setupTools(self):
        ...
        self.acn_polygonize = QAction(QIcon('icons/ic_polygonize.svg'), 'polygonize', self.grp_imageTools)
